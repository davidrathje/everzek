...
/**
 * This file was originally found here: https://github.com/Shendare/EQZip/blob/master/EQArchive.cs
 * Modifications were done to make support for Unity, primarily due to System.Drawing is not natively supported.
 **/
...
public class EQArchive
{
    ...
    public static EQArchive Load(string FilePath) { return Load(FilePath, File.ReadAllBytes(FilePath)); }
    ...
    public Texture2D GetImage()
    {
        ...
        try
        {
          //  _loading = new Bitmap(_stream);
            ...
            this.ImageFormat = Path.GetExtension(this.Filename).ToLower();
        }
        catch
        {
            //_loading = null;
